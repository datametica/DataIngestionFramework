...
"""This module contains the implementation of a BigQuery Stream Writer that can be used to write data to BigQuery.
"""
import base64
from abc import ABC
...
class BigQueryStreamWriter(BaseOutputWriter, ABC):
    """This class contains the implementation of a BigQuery Stream Writer that can be used to write data to BigQuery.
    """
    ...
    def __init__(self, task, prop_dict):
        ...
        self.write_disposition = prop_dict["write_disposition"].upper()
    ...
    def expand(self, p_input):
        ...
        return p_input | "Prepare Data" >> beam.ParDo(PrepareData()) \
